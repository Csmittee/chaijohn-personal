...
> P&L Generator — 3 targeted fixes
...
- [ ] Fill Direct material and Labor → Save → reload → values restored correctly
- [ ] Drag handle visible between sidebar and output area
- [ ] Drag resizes sidebar from min 220px to max 480px, label text fully readable
- [ ] After Generate: chart area shows P&L chart on left AND cashflow bars on right
- [ ] Cashflow bars show cash-in vs cash-out per period matching 12mo/5yr toggle
