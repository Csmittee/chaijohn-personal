...
2. Update `masterseed.md`:
   ...
   - Update FILE INVENTORY: add all new files
...
3. Append new lessons to `lessons_learned.md` (next L after current highest):
   ...
   - Auto-calculated milestone from task dates
   - Phase auto-creation on project create
   - Any Airtable schema decisions made during build

4. Commit: `docs: update masterseed and lessons_learned after phase9c`
...
docs: update masterseed and lessons_learned after phase9c
```
